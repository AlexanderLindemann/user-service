...
public class NotificationServiceRewardTransactionEventProducerImpl implements NotificationServiceRewardTransactionEventProducer {
    ...
    public void handle(NotificationRewardEvent event) {
